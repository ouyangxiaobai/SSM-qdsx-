...
<style>
	...
	body {
				background-image: url(http://bpic.588ku.com/back_pic/19/03/20/c61bf288244ae8807118416c6df8442f.jpg) !important;
	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">经理工号</label> 
							<input type="text" name="jingligonghao" placeholder="经理工号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="mima" placeholder="密码" class="form-control-i">
																								...
																								<div class="form-group">
							<label class="label">经理姓名</label> 
							<input type="text" name="jinglixingming" placeholder="经理姓名" class="form-control-i">
							</div>
																																														<div class="form-group">
							<label class="label">职务</label> 
							<input type="text" name="zhiwu" placeholder="职务" class="form-control-i">
							</div>
																								<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				$.ajax({ 
					type: "POST",
					url: baseUrl + "bumenjingli/register",
